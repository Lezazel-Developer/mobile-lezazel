...
class _FavoriteScreenState extends State<FavoriteScreen> {
  ...
  void _showDeleteConfirmation(BuildContext context, int index) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Are you sure to remove this one?'),
              ...
              children: [
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    child: Icon(
                      likedList[index] ? Icons.favorite : Icons.favorite_outline,
                      color: likedList[index] ? Colors.amber : Color(0xffFEA300),
                      size: 30,
                    ),
                  ),
                ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all(const Color(0xfffea300)),
              ),
              onPressed: () {},
              child: const Text('Explore Store', style: TextStyle(color: Colors.black),)
